...
public class ThirdPartyControllerTest {
    ...
    void setUp() {
        ...
        accountHolderTest1 = new AccountHolder("Test May Lord", "test1@email.com", "tastpass", LocalDate.of(1989, 3, 22),
        ...
        accountHolderTest2 = new AccountHolder("Test Kant BeRight", "test2@email.com", "tastpas2", LocalDate.of(2010, 1, 24),
                new Address("Test Crisol ave. 365", "Test New York", "Test 46266"),
                null);
        accountHolderRepository.save(accountHolderTest2);

        accountTest1 = new Checking(new Money(BigDecimal.valueOf(5000.53)), accountHolderTest1, accountHolderTest2);
        ...
        thirdPartyTest = new ThirdParty("Test S.A.", "email@test.com", "adminpass");
