...
public class CreditCardRepositoryTest {
    ...
    void setUp() {
        ...
        accountTest1 = new CreditCard(new Money(BigDecimal.valueOf(9988.77)), accountHolderTest1,
                accountHolderTest2);
        creditcardRepository.save(accountTest1);
    }

    @Test
    @DisplayName("Check method findBySecretKey on CreditCard")
    void findCreditCardBySecretKey_OK () {
        String secretKeyTest = accountTest1.getSecretKey();

        assertTrue(creditcardRepository.findBySecretKey(secretKeyTest).isPresent());
