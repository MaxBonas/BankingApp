...
public class CheckingRepositoryTest {
    ...
    @Test
    @DisplayName("Check method findBySecretKey on Checking")
    void findCheckingBySecretKey_OK () {
        String secretKeyTest = accountTest1.getSecretKey();

        assertTrue(checkingRepository.findBySecretKey(secretKeyTest).isPresent());
